        ...
        <section className="py-2 text-center container">
          <div className="row py-lg-2">
            <div className="col-lg-6 col-md-8 mx-auto d-flex justify-content-center align-items-center flex-column">
              <img style={{ width: '100%' }} className='imagen-titulo mt-0' src={Titulo} alt="Título de la página" />
              <div>
                <div class="input-group mb-3">
                  <input type="text" class="form-control" placeholder="Buscar Personaje" aria-label="Recipient's username" aria-describedby="button-addon2"/>
